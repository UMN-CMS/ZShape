...
namespace {
  ...
  struct dictionary {
    ...
    edm::RefToBase<reco::RecoEcalCandidate> rtbg;
    edm::reftobase::IndirectHolder<reco::RecoEcalCandidate> ihg;
    edm::RefToBaseProd<reco::RecoEcalCandidate> rtbpg;
    edm::RefToBaseVector<reco::RecoEcalCandidate> rtbvg;
    edm::Wrapper<edm::RefToBaseVector<reco::RecoEcalCandidate> > rtbvg_w;
    edm::reftobase::BaseVectorHolder<reco::RecoEcalCandidate> *bvhg_p;
    ...
    edm::Wrapper<edm::RefVector<reco::RecoEcalCandidateCollection> > rv2_w;
