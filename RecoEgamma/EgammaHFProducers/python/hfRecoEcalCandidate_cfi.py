...
hfRecoEcalCandidate = cms.EDProducer("HFRecoEcalCandidateProducer",
                                     ...
                                     HFDBvector=cms.vdouble(
                                                                      ...
                                                                      #pm 0.0439/0.1616(31)
                                                                      0.1902,
                                                                      0.1902,0.1902,0.1902,0.1902,
                                                                      0.1902,0.1902,0.1902,0.1902,
                                                                      0.1902,0.1412,0.1902,0.1902,
                                                                      0.1902,0.1902,0.1412,0.1902,
                                                                      0.1902,0.1902,0.1902,0.1902,
                                                                      0.1902,0.1902,0.1902,0.1902,
                                                                      0.1902)
                                     )
...
hfRecoEcalCandidateMC = cms.EDProducer("HFRecoEcalCandidateProducer",
        e9e25Cut = cms.double(0.94),
        hfclusters = cms.InputTag("hfEMClusters"),
        VertexCollection = cms.InputTag("offlinePrimaryVertices"),
        intercept2DCut = cms.double(0.815),
        ...
        HFDBvector=cms.vdouble(
            ...
            #pm 0.0439/0.1616(31)
            mc_all,
            mc_all,mc_all,mc_all,mc_all,
            mc_all,mc_all,mc_all,mc_all,
            mc_all,mc_ieta30,mc_all,mc_all,
            mc_all,mc_all,mc_ieta30,mc_all,
            mc_all,mc_all,mc_all,mc_all,
            mc_all,mc_all,mc_all,mc_all,
            mc_all)
        )
...
##  41
 ...
 #energy corrections-old version 1
