...
double CutBasedElectronID::cicSelection(const reco::GsfElectron* electron, const edm::Event& e, const edm::EventSetup& es) {
...
double CutBasedElectronID::robustSelection(const reco::GsfElectron* electron , const edm::Event& e , const edm::EventSetup& es) {
    ...
    double rhoCorrection = 0; // Only set to non-zero if Alex's code is included
    ...
    if (version_ == "V20"){
        ...
        edm::InputTag caloTowersTag_("towerMaker");
        e.getByLabel(caloTowersTag_,caloTowersHandle_);

        float egHcalIsoConeSizeOutSmall=0.3;
        float egHcalIsoConeSizeIn=0.0, egHcalIsoPtMin=0.0;
        int egHcalDepth1=1, egHcalDepth2=2;
        EgammaTowerIsolation hadDepth1Isolation03(egHcalIsoConeSizeOutSmall,egHcalIsoConeSizeIn,egHcalIsoPtMin,egHcalDepth1,caloTowersHandle_.product()) ;
        EgammaTowerIsolation hadDepth2Isolation03(egHcalIsoConeSizeOutSmall,egHcalIsoConeSizeIn,egHcalIsoPtMin,egHcalDepth2,caloTowersHandle_.product()) ;
        float hcalDepth1TowerSumEt03 = hadDepth1Isolation03.getTowerEtSum(&(*electron));
        float hcalDepth2TowerSumEt03 = hadDepth2Isolation03.getTowerEtSum(&(*electron));
        hcalIso = hcalDepth1TowerSumEt03+hcalDepth2TowerSumEt03;
