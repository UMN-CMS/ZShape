...
process.HFXmeanX1XXsmear = ZShape.EffAcc.FullSimSmearedElectronProducer_cfi.FullSimSmearedElectronsProducer.clone()
process.HFXmeanX1XXsmear.HF.meanp = cms.double(1.)
process.HFXmeanX1XXsmear.HF.meanm = cms.double(1.)

process.HFXmeanX1X = ZShape.EffAcc.ZEfficiencyKevin_cfi.mcEff.clone()
process.HFXmeanX1X.zTreeLevelElectronsCollection = cms.untracked.InputTag("f2s","ZEventEle3")
process.HFXmeanX1X.zsrc = cms.untracked.InputTag("HFXmeanX1XXsmear","ZEventParticles")
process.HFXmeanX1X.zElectronsCollection = cms.untracked.InputTag("HFXmeanX1XXsmear","ZEventParticles")
