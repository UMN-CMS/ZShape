...
process.EBXmeanX0X996Xsmear = ZShape.EffAcc.FullSimSmearedElectronProducer_cfi.FullSimSmearedElectronsProducer.clone()
process.EBXmeanX0X996Xsmear.EB.mean = cms.double(0.996)

process.EBXmeanX0X996 = ZShape.EffAcc.ZEfficiencyKevin_cfi.mcEff.clone()
process.EBXmeanX0X996.zTreeLevelElectronsCollection = cms.untracked.InputTag("f2s","ZEventEle3")
process.EBXmeanX0X996.zsrc = cms.untracked.InputTag("EBXmeanX0X996Xsmear","ZEventParticles")
process.EBXmeanX0X996.zElectronsCollection = cms.untracked.InputTag("EBXmeanX0X996Xsmear","ZEventParticles")
...
+ process.EBXmeanX0X996Xsmear
+ process.EBXmeanX0X996
)
