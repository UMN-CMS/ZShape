...
process.hfEMClusters.correctionType = cms.int32(2)
...
process.InvNTElecTight = cms.EDFilter("PhotonSelector",
                                   src = cms.InputTag("photons"),
                                   cut = cms.string("(superCluster.rawEnergy*sin(superCluster.position.theta)>20.0)"
                                                    " && (abs(superCluster.eta)>2.5) " # && abs(superCluster.eta)<2.8
                                                    " && ((sigmaIetaIeta>0.03)"
                                                    " || (ecalRecHitSumEtConeDR03/(p4.Pt) > 0.05)"
                                                    " || (hcalTowerSumEtConeDR03/(p4.Pt) > 0.025)"
...
process.InvWP95 = cms.EDFilter("PATElectronRefSelector",
                                src = cms.InputTag("patElectrons"),
                                cut = cms.string(process.PassingGsf.cut.value() +' && pt > 15.0 && ( electronID("simpleEleId95relIso") != 3 ) && ( electronID("simpleEleId95relIso") != 7 )')
)
process.InvWP90 = cms.EDFilter("PATElectronRefSelector",
                                src = cms.InputTag("patElectrons"),
                                cut = cms.string(process.PassingGsf.cut.value() +' && pt > 15.0 && ( electronID("simpleEleId90relIso") != 3 ) && ( electronID("simpleEleId90relIso") != 7 )')
)

process.InvWP85 = cms.EDFilter("PATElectronRefSelector",
                                src = cms.InputTag("patElectrons"),
                                cut = cms.string(process.PassingGsf.cut.value() +' && pt > 15.0 && ( electronID("simpleEleId85relIso") != 3 ) && ( electronID("simpleEleId85relIso") != 7 )')
)
...
process.InvWP70 = cms.EDFilter("PATElectronRefSelector",
                                src = cms.InputTag("patElectrons"),
                                cut = cms.string(process.PassingGsf.cut.value() +' && pt > 15.0 && ( electronID("simpleEleId70relIso") != 3 ) && ( electronID("simpleEleId70relIso") != 7 )')
)
process.InvWP60 = cms.EDFilter("PATElectronRefSelector",
                                src = cms.InputTag("patElectrons"),
                                cut = cms.string(process.PassingGsf.cut.value() +' && pt > 15.0 && ( electronID("simpleEleId60relIso") != 3 ) && ( electronID("simpleEleId70relIso") != 7 )')
)
...
process.PassingHLT = cms.EDProducer("trgMatchedGsfElectronProducer",                     
    ...
    hltTag = cms.untracked.VInputTag(
                ...
                cms.InputTag("HLT_Ele17_CaloIdL_CaloIsoVL_Ele15_HFL_v5","","HLT"),
                cms.InputTag("HLT_Ele17_CaloIdL_CaloIsoVL_Ele15_HFL_v6","","HLT"),
                cms.InputTag("HLT_Ele17_CaloIdL_CaloIsoVL_Ele15_HFL_v7","","HLT"),
                ...
                cms.InputTag("HLT_Ele17_CaloIdL_CaloIsoVL_Ele8_CaloIdL_CaloIsoVL_v4","","HLT"),
                cms.InputTag("HLT_Ele17_CaloIdL_CaloIsoVL_Ele8_CaloIdL_CaloIsoVL_v5","","HLT"),
                cms.InputTag("HLT_Ele17_CaloIdL_CaloIsoVL_Ele8_CaloIdL_CaloIsoVL_v6","","HLT"),
    ),
...
process.InvNTTightMatchedSuperClusterCands = process.TagMatchedSuperClusterCandsClean.clone()
process.InvNTTightMatchedSuperClusterCands.ReferenceCandidateCollection = cms.untracked.InputTag("InvNTElecTight")
...
process.ele_sequence = cms.Sequence(
    ...
    process.NTTightMatchedSuperClusterCands * process.InvNTTightMatchedSuperClusterCands *
...
process.tagInvWP80HFSuperClusters = cms.EDProducer("CandViewShallowCloneCombiner",
    decay = cms.string("InvWP80Tag theHFSuperClusters"), # charge coniugate states are implied
    cut   = cms.string("40 < mass < 600"),
    checkCharge = cms.bool(False),
)
...
process.tagIdFINAL = cms.EDProducer("BestZProducer",
    randomSeed = cms.untracked.int32(100),
    outcol =  cms.untracked.string("tagIdFINAL"),                             
    allProbeCandTags = cms.untracked.VInputTag(cms.InputTag("tagId"))
)

process.tagHFEIDFINAL = cms.EDProducer("BestZProducer",
    randomSeed = cms.untracked.int32(100),
    outcol =  cms.untracked.string("tagHFEIDFINAL"),                             
    allProbeCandTags = cms.untracked.VInputTag(cms.InputTag("tagHFEID"))
)

process.tagNTTEIDFINAL = cms.EDProducer("BestZProducer",
    randomSeed = cms.untracked.int32(100),
    outcol =  cms.untracked.string("tagNTTEIDFINAL"),                             
    allProbeCandTags = cms.untracked.VInputTag(cms.InputTag("tagNTTEID"))
)
...
process.allTagsAndProbes = cms.Sequence(
    ...
    process.tagIso80 + process.tagId80 + process.tagHLT80 + process.tagIdFINAL +
    process.tagHFSuperClusters + process.tagHFEID + process.tagNTTEID + process.tagInvWP80HFSuperClusters +
    process.tag80SC + process.tag80Gsf + process.tagInvWP80Gsf + process.tagInvWP80SC + process.tagNTTEIDFINAL +
    process.tagHFEIDFINAL 
)
...
process.InvWP80HFSCToEID = process.HFSCToEID.clone() 
process.InvWP80HFSCToEID.tagProbePairs = cms.InputTag("tagInvWP80HFSuperClusters")
...
process.HFEIDFINAL = process.HFEID.clone()
process.HFEIDFINAL.tagProbePairs = cms.InputTag("tagHFEIDFINAL","tagHFEIDFINAL")

process.HFEIDFINALOP = process.HFEID.clone()
process.HFEIDFINALOP.arbitration  = cms.string("OnePair")
...
process.PhotonToNTFINAL = process.PhotonToNT.clone()
process.PhotonToNTFINAL.tagProbePairs = cms.InputTag("tagNTTEIDFINAL","tagNTTEIDFINAL")

process.PhotonToNTFINALOP = process.PhotonToNT.clone()
process.PhotonToNTFINALOP.arbitration   = cms.string("OnePair")
...
process.IdToHLTFINAL = process.IdToHLT.clone()
process.IdToHLTFINAL.tagProbePairs = cms.InputTag("tagIdFINAL","tagIdFINAL")

process.IdToHLTFINALOP = process.IdToHLT.clone()
process.IdToHLTFINALOP.arbitration   = cms.string("OnePair")
...
process.tree_sequence = cms.Sequence(
    ...
    process.PhotonToGsf + process.HFEID + process.PhotonToNT + process.InvWP80HFSCToEID +
    process.HFEIDFINAL + process.HFEIDFINALOP + process.PhotonToNTFINAL +process.PhotonToNTFINALOP +
    process.GsfToIso +
    process.IsoToId + process.IdToHLT + process.IdToHLTFINAL + process.IdToHLTFINALOP +
