...
process.goodSuperClusters = cms.EDFilter("CandViewSelector",
      ...
      cut = cms.string("et>20.0 && abs(eta)<2.9 && !(1.4442< abs(eta) <1.566)"), #changed 2.5->2.9
...
process.PassingHLT = cms.EDProducer("trgMatchedGsfElectronProducer",                     
    ...
    hltTag = cms.untracked.VInputTag(
                ...
                cms.InputTag("HLT_Ele15_SW_LooseTrackIso_L1R"),
...
process.ele_sequence = cms.Sequence(
    ...
    process.PassingHLT + process.PassingHLT80 +  process.Tag* process.Tag80*  process.InvWP95Tag * process.InvWP80Tag *
