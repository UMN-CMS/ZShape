...
process.EBXcX0X014Xsmear = ZShape.EffAcc.FullSimSmearedElectronProducer_cfi.FullSimSmearedElectronsProducer.clone()
process.EBXcX0X014Xsmear.EB.c = cms.double(0.014)

process.EBXcX0X014 = ZShape.EffAcc.ZEfficiencyKevin_cfi.mcEff.clone()
process.EBXcX0X014.zTreeLevelElectronsCollection = cms.untracked.InputTag("f2s","ZEventEle3")
process.EBXcX0X014.zsrc = cms.untracked.InputTag("EBXcX0X014Xsmear","ZEventParticles")
process.EBXcX0X014.zElectronsCollection = cms.untracked.InputTag("EBXcX0X014Xsmear","ZEventParticles")

process.EBXcX0X018Xsmear = ZShape.EffAcc.FullSimSmearedElectronProducer_cfi.FullSimSmearedElectronsProducer.clone()
process.EBXcX0X018Xsmear.EB.c = cms.double(0.018)

process.EBXcX0X018 = ZShape.EffAcc.ZEfficiencyKevin_cfi.mcEff.clone()
process.EBXcX0X018.zTreeLevelElectronsCollection = cms.untracked.InputTag("f2s","ZEventEle3")
process.EBXcX0X018.zsrc = cms.untracked.InputTag("EBXcX0X018Xsmear","ZEventParticles")
process.EBXcX0X018.zElectronsCollection = cms.untracked.InputTag("EBXcX0X018Xsmear","ZEventParticles")

process.EBXcX0X22Xsmear = ZShape.EffAcc.FullSimSmearedElectronProducer_cfi.FullSimSmearedElectronsProducer.clone()
process.EBXcX0X22Xsmear.EB.c = cms.double(0.22)

process.EBXcX0X22 = ZShape.EffAcc.ZEfficiencyKevin_cfi.mcEff.clone()
process.EBXcX0X22.zTreeLevelElectronsCollection = cms.untracked.InputTag("f2s","ZEventEle3")
process.EBXcX0X22.zsrc = cms.untracked.InputTag("EBXcX0X22Xsmear","ZEventParticles")
process.EBXcX0X22.zElectronsCollection = cms.untracked.InputTag("EBXcX0X22Xsmear","ZEventParticles")
...
+ process.EBXcX0X01
+ process.EBXcX0X014Xsmear
+ process.EBXcX0X014
+ process.EBXcX0X018Xsmear
+ process.EBXcX0X018
+ process.EBXcX0X22Xsmear
+ process.EBXcX0X22
)
