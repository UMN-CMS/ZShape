...
process.HFXmeanX-0X2Xsmear = ZShape.EffAcc.FullSimSmearedElectronProducer_cfi.FullSimSmearedElectronsProducer.clone()
process.HFXmeanX-0X2Xsmear.HF.mean = cms.double(-0.2)

process.HFXmeanX-0X2 = ZShape.EffAcc.ZEfficiencyKevin_cfi.mcEff.clone()
process.HFXmeanX-0X2.zTreeLevelElectronsCollection = cms.untracked.InputTag("f2s","ZEventEle3")
process.HFXmeanX-0X2.zsrc = cms.untracked.InputTag("HFXmeanX-0X2Xsmear","ZEventParticles")
process.HFXmeanX-0X2.zElectronsCollection = cms.untracked.InputTag("HFXmeanX-0X2Xsmear","ZEventParticles")

process.HFXmeanX-0X15Xsmear = ZShape.EffAcc.FullSimSmearedElectronProducer_cfi.FullSimSmearedElectronsProducer.clone()
process.HFXmeanX-0X15Xsmear.HF.mean = cms.double(-0.15)

process.HFXmeanX-0X15 = ZShape.EffAcc.ZEfficiencyKevin_cfi.mcEff.clone()
process.HFXmeanX-0X15.zTreeLevelElectronsCollection = cms.untracked.InputTag("f2s","ZEventEle3")
process.HFXmeanX-0X15.zsrc = cms.untracked.InputTag("HFXmeanX-0X15Xsmear","ZEventParticles")
process.HFXmeanX-0X15.zElectronsCollection = cms.untracked.InputTag("HFXmeanX-0X15Xsmear","ZEventParticles")

process.HFXmeanX-0X1Xsmear = ZShape.EffAcc.FullSimSmearedElectronProducer_cfi.FullSimSmearedElectronsProducer.clone()
process.HFXmeanX-0X1Xsmear.HF.mean = cms.double(-0.1)

process.HFXmeanX-0X1 = ZShape.EffAcc.ZEfficiencyKevin_cfi.mcEff.clone()
process.HFXmeanX-0X1.zTreeLevelElectronsCollection = cms.untracked.InputTag("f2s","ZEventEle3")
process.HFXmeanX-0X1.zsrc = cms.untracked.InputTag("HFXmeanX-0X1Xsmear","ZEventParticles")
process.HFXmeanX-0X1.zElectronsCollection = cms.untracked.InputTag("HFXmeanX-0X1Xsmear","ZEventParticles")

process.HFXmeanX-0X05Xsmear = ZShape.EffAcc.FullSimSmearedElectronProducer_cfi.FullSimSmearedElectronsProducer.clone()
process.HFXmeanX-0X05Xsmear.HF.mean = cms.double(-0.05)

process.HFXmeanX-0X05 = ZShape.EffAcc.ZEfficiencyKevin_cfi.mcEff.clone()
process.HFXmeanX-0X05.zTreeLevelElectronsCollection = cms.untracked.InputTag("f2s","ZEventEle3")
process.HFXmeanX-0X05.zsrc = cms.untracked.InputTag("HFXmeanX-0X05Xsmear","ZEventParticles")
process.HFXmeanX-0X05.zElectronsCollection = cms.untracked.InputTag("HFXmeanX-0X05Xsmear","ZEventParticles")
...
+ process.HFXmeanX-0X2Xsmear
+ process.HFXmeanX-0X2
+ process.HFXmeanX-0X15Xsmear
+ process.HFXmeanX-0X15
+ process.HFXmeanX-0X1Xsmear
+ process.HFXmeanX-0X1
+ process.HFXmeanX-0X05Xsmear
+ process.HFXmeanX-0X05
