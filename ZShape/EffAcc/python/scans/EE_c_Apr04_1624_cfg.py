...
process.EEXcX0X022Xsmear = ZShape.EffAcc.FullSimSmearedElectronProducer_cfi.FullSimSmearedElectronsProducer.clone()
process.EEXcX0X022Xsmear.EE.c = cms.double(0.022)

process.EEXcX0X022 = ZShape.EffAcc.ZEfficiencyKevin_cfi.mcEff.clone()
process.EEXcX0X022.zTreeLevelElectronsCollection = cms.untracked.InputTag("f2s","ZEventEle3")
process.EEXcX0X022.zsrc = cms.untracked.InputTag("EEXcX0X022Xsmear","ZEventParticles")
process.EEXcX0X022.zElectronsCollection = cms.untracked.InputTag("EEXcX0X022Xsmear","ZEventParticles")
