...
process.HFXmeanXm1 = ZShape.EffAcc.ZEfficiencyKevin_cfi.mcEff.clone()
process.HFXmeanXm1.zTreeLevelElectronsCollection = cms.untracked.InputTag("f2s","ZEventEle3")
process.HFXmeanXm1.zsrc = cms.untracked.InputTag("HFXmeanX-1Xsmear","ZEventParticles")
process.HFXmeanXm1.zElectronsCollection = cms.untracked.InputTag("HFXmeanX-1Xsmear","ZEventParticles")
