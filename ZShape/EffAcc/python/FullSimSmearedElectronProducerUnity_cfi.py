...
FullSimSmearedElectronsProducer = cms.EDProducer("ZSmearingProducer",
    ...
    HF = cms.PSet(
       ...
       constantp = cms.double(0.00001),#088),#uncert 0.02
       constantm = cms.double(0.00001),#090),#uncert 0.0143
       constantp2 = cms.double(0.00001),#uncert 0.02
       constantm2 = cms.double(0.00001),#uncert 0.0143
       fraction2 = cms.double(0.00),
       meanp = cms.double(1.00),#985),  #uncert 0.007 
       meanm = cms.double(1.00),#986),  #uncert 0.009
    ...
    EB = cms.PSet(
       ...
       p1 = cms.double(0.0),
       p2 = cms.double(0.0),
       c = cms.double(0.00001),# uncertainty 0.002 
