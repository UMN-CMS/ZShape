...
B0=['TH1F','EffSystEE-EB','FinalEffSystEE-EB']
...
B2={'WP80P.root':['WP80','CynCirc'],
    'HFSC.root':['HF Supercluster','RedCirc'],
    'HFEIDP.root':['HF Electron ID','GrnSqur'],
    'HLTP.root':['HLT','MagnTri'],
    'GSFP.root':['GSF Track Match','BlueTri'],
    'SCP.root':['Supercluster','OrngTri']#,
