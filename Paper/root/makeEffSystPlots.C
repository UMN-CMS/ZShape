...
plotEffSyst(my95,my95hf,myo95p, "Z0_Pt", "Plus");
myo95p->Write();
plotEffSyst(my95,my95hf,myo95m, "Z0_Pt", "Minus");
myo95m->Write();
plotEffSyst(my80,my80hf, myo80p, "Z0_Pt", "Plus");
myo80p->Write();
plotEffSyst(my80,my80hf, myo80m, "Z0_Pt", "Minus");
myo80m->Write();
plotEffSyst(myGSF,myGSFhf, myoGSFp, "Z0_Pt", "Plus");
myoGSFp->Write();
plotEffSyst(myGSF,myGSFhf, myoGSFm, "Z0_Pt", "Minus");
myoGSFm->Write();
plotEffSyst(myHFEID,myHFEIDhf,myoHFEIDp, "Z0_Pt", "Plus");
myoHFEIDp->Write();
plotEffSyst(myHFEID,myHFEIDhf,myoHFEIDm, "Z0_Pt", "Minus");
myoHFEIDm->Write();
plotEffSyst(myHFSC,myHFSChf,myoHFSCp, "Z0_Pt", "Plus");
myoHFSCp->Write();
plotEffSyst(myHFSC,myHFSChf,myoHFSCm, "Z0_Pt", "Minus");
myoHFSCm->Write();
plotEffSyst(mySC,mySChf,myoSCp, "Z0_Pt", "Plus");
myoSCp->Write();
plotEffSyst(mySC,mySChf,myoSCm, "Z0_Pt", "Minus");
myoSCm->Write();
plotEffSyst(myHLT,myHLThf,myoHLTp, "Z0_Pt", "Plus");
myoHLTp->Write();
plotEffSyst(myHLT,myHLThf,myoHLTm, "Z0_Pt", "Minus");
myoHLTm->Write();
plotEffSyst(myNT,myNThf,myoNTp, "Z0_Pt", "Plus");
myoNTp->Write();
plotEffSyst(myNT,myNThf,myoNTm, "Z0_Pt", "Minus");
myoNTm->Write();
myoNTm->Close();
