...
/* Compile time notes:
 *    g++ -O2 -o fitEffAcc_trigger_with_inbuilt_hf_correction_with_smearing.exe fitEffAcc_trigger_with_inbuilt_hf_correction_with_smearing.cc ZEffTree.cc Background.cc `root-config --cflags --libs` 
 */
